...
const Requests = () => {
    ...
    if(requests.length === 0 ) return <h1 className="felx justify-self-center my-10"> No Requests Found</h1>;
        ...
        return (
            <div key={_id} className="flex justify-between items-center m-4 p-4 rounded-lg bg-base-300 w-1/2 mx-auto"> 
                ...
                <div>
                    ...
                    <button className="btn btn-active btn-secondary mx-2" onClick={() => reviewRequest("rejected", request._id)}>Reject</button>
                </div>
            </div>
        );    
        })}
